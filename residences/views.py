...
from .models import RegionEnum, Residence
...
class ResidenceListView(View):
    def get(self, request):
        ...
        residences = Residence.objects.filter(**filter_set).select_related('region', 'category').prefetch_related('rooms', 'residence_images').order_by(sort_type[sort])[offset:offset+limit]
